        ...
        <>
                ...
                <Container>
                    <div className={styles.comunidadInner}>
                        ...
                        <aside className={styles.citeCol} data-aos="fade-right" data-aos-delay="200">
                            ...
                            <span className={styles.citeAuthor}>ʻAbduʼl-Bahá</span>
                        </aside>
                        ...
                        <div className={styles.contentCol} data-aos="fade-left">
                            ...
                            <p className={styles.bodyText}>
                                La Fe Baháʼí en Bolivia comienza con referencias al país en la literatura baháʼí 
                                en 1916. La primera baháʼí en llegar a Bolivia fue la Sra. Eleanor Adler, quien 
                                llegó a la ciudad de La Paz en 1940. Meses después, en 1941, la Sra. Yvonne de Cuellar 
                                reconoce el Mensaje de Bahá’u’lláh, convirtiéndose en la “Madre Espiritual de Bolivia”.
                            </p>
                            ...
                            <p className={styles.bodyTextRef}>
                                La Asamblea Espiritual Local de los Baháʼís de la Paz, 1945. Sentada 
                                (la segunda mujer desde la izquierda, sosteniendo la foto) la señora Yvonne de Cuellar
                            </p>
                            <p className={styles.bodyText}>
                                En 1945 ya se cuenta con un buen grupo de creyentes en La Paz, que elige a su primera 
                                institución, la Asamblea Espiritual Local, encargada de atender los asuntos de la creciente 
                                comunidad. En 1956, Andrés Jachacollo fue el primer boliviano nativo en reconocer el Mensaje 
                                de Bahá’u’lláh como una respuesta a las profecías que tenían sus antepasados y, junto con 
                                otros amigos que pronto ingresaron a la Fe, se dedicaron a llevar el Mensaje de Bahá’u’lláh a 
                                numerosas comunidades del altiplano boliviano y de esta manera la Fe crece rápidamente y se crea 
                                un movimiento muy grande, especialmente en las áreas rurales. En 1961, la comunidad bahá’í de 
                                Bolivia eligió su primera Asamblea Espiritual Nacional.
                            </p>
                ...
                <Container>
                    <div className={styles.feMundialInner}>
                        ...
                        <div className={styles.contentCol} data-aos="fade-left">
                            ...
                            <p className={styles.bodyText}>
                                El mensaje principal que trajo Bahá’u’lláh para el mundo es la unidad. Nos dice que 
                                somos los frutos de un solo árbol y las hojas de una sola rama. Seamos mujeres u hombres, 
                                campesinos o citadinos, todos somos hijos de un solo Dios, todos somos hermanos. Debemos 
                                ser unidos como las flores de un mismo jardín y celebrar que somos algo diferentes, porque 
                                eso hace que el jardín de la humanidad sea más colorido y hermoso.
                            </p>

                            <p className={styles.bodyText}>
                                Hace unos 200 años, cuando vino Bahá’u’lláh, solo conocíamos los lugares más cercanos a 
                                nosotros y solo podíamos conversar con las personas que estaban a nuestro lado, pero ahora 
                                ya podemos viajar más rápido que el sonido y podemos conversar y vernos en tiempo real con 
                                personas que están al otro lado del mundo. Ya ha llegado el tiempo para la unidad de la humanidad.
                            </p>
                            ...
                            <div className={styles.videoWrapper} data-aos="zoom-in" data-aos-delay="100">
                                <iframe
                                    src="https://player.vimeo.com/video/238264211?api=1&amp;player_id=player"
                            ...
                            <p className={styles.bodyText}>
                                Bahá’u’lláh nos enseña que hay un solo Dios, en el cual todos creemos, solo que en diferentes 
                                idiomas la palabra Dios suena un poco diferente. También nos enseña que a lo largo de los 
                                tiempos Dios nos ha mandado Mensajeros Divinos, entre ellos Abraham, Moisés y Jesús, que nos han 
                                traído la Guía de Dios, de acuerdo con el desarrollo que tenía la humanidad en cada época, 
                                construyendo siempre sobre las enseñanzas que trajo el Mensajero de Dios que vino antes, y 
                                avisando también que vendría otro en un futuro. Así, para traer el remedio que necesita la 
                                humanidad en esta época tan importante que estamos viviendo, Dios nos mandó a dos Mensajeros: 
                                El Báb (que significa La Puerta) y Bahá’u’lláh (que significa La Gloria de Dios).
                            </p>
                ...
                <div className={styles.creeemosCont}>
                    <div className={styles.creemosBanner} data-aos="fade-up">
                        <div className={styles.creemosBannerLeft}>
                            ...
                            <a href="creencias" className={styles.creemosLink}>Descubre más →</a>
                        </div>
            ...
            <section className={styles.quoteFinalSection}>
                <div className={styles.bAdornoWrapper}>
                    <img src="/assets/identidadImages/b.png" alt="letra b" className={styles.bAdorno}  />
                </div>
